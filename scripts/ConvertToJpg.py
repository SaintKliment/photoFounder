...
for filename in os.listdir(folder_path):
    ...
    # Проверяем, является ли файл изображением и не является ли оно уже формата .jpg или .jpeg
    if os.path.isfile(file_path) and not filename.lower().endswith(('.jpg', '.jpeg')):
        try:
    ...
    #else:
        # print(f'Пропущен: {file_path} (уже JPG)')
